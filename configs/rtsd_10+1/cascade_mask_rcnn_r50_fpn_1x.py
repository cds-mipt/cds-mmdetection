...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'JSON/full-gt-8_22-each4-10+1_train_withsegm.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'JSON/full-gt-8_22-each4-10+1_val_withsegm.json',
        img_prefix=data_root + 'rtsd-frames/',
        img_scale=(1333, 800),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_mask_rcnn_r50_fpn_1x_rtsd_10+1_8_22'
load_from = 'checkpoints/rtsd_10+1/cascade_mask_rcnn_r50_fpn_20e_20181123-6e0c9713.pth'
resume_from = None
workflow = [('train', 1)]
